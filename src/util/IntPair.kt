...
fun Point.directionTo(other: Point): Direction {
  ...
  return when {
    ...
    x() < other.x() && y() > other.y() -> Direction.NORTH_EAST
    x() > other.x() && y() > other.y() -> Direction.NORTH_WEST
    x() < other.x() && y() < other.y() -> Direction.SOUTH_EAST
    x() > other.x() && y() < other.y() -> Direction.SOUTH_WEST
    else -> throw IllegalArgumentException("This should be impossible.")
  }
}
